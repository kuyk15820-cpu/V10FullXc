...
$(APPLICATION_NAME)_EXTRA_FRAMEWORKS += ffmpegkit Lottie FirebaseRemoteConfig FirebaseRemoteConfigInterop FirebaseCore FirebaseCoreInternal FirebaseInstallations FBLPromises GoogleUtilities nanopb
